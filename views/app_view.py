...
class MyApp(App):
    ...
    async def on_mount(self) -> None:
        ...
        await self.push(header)
        await self.push(footer)

        # Add the left side container with the buttons
        await self.push(self.button_container)

        # Add the main content area
        await self.push(self.main_container)
